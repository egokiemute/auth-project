    ...
    >
      ...
      {!ninStatus ? (
        <div className="flex gap-2 items-center mb-6">
          ...
          <p className="text-xs text-white">NIN Under Verification</p>
        </div>
      ) : (
		<div className="flex gap-2 items-center mb-6">
          <div className="bg-[#ffffff] w-2 h-2 rounded-full animate-pulse" />
          <p className="text-xs text-white">NIN Verified</p>
        </div>
	  )}
